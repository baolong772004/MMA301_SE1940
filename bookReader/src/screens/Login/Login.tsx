...
import { View, TextInput, TouchableOpacity, Text, Platform, KeyboardAvoidingView } from 'react-native';
                        ...
                        >
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 12, gap: 12 }}>
                                <TouchableOpacity
                                    ...
                                    style={{ flex: 1, paddingVertical: 10, borderRadius: 10, backgroundColor: '#6B46C1', alignItems: 'center' }}
                                >
                                    <Text style={{ color: 'white', fontWeight: '700' }}>Đăng nhập Admin</Text>
                                </TouchableOpacity>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ flex: 1, paddingVertical: 10, borderRadius: 10, backgroundColor: '#E6E6EA', alignItems: 'center' }}
                                >
                                    <Text style={{ color: '#333', fontWeight: '700' }}>Đăng nhập User</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
